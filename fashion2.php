    ...
    <div class="mainLeasure" style="">
      ...
      <div class="column3" style=" width:302px; float:left; position:relative;"> 
        ...
        <div class="column2" style="width:295px;float:left; color:#666; background:#fff; height:485px;text-align:center;">
            ...
            <p style=" text-align:center;font-family:微软雅黑,Microsoft YaHei,simhei, 黑体; font-size:12px; line-height:20px; padding:25px 25px 20px 25px;">任何服装的款式都是能够被复制和制造的<br />只有它的灵魂和精神是可以永存的. <br />服装并不只是种产品, 更应该是一种态度的<br />体现. 于是, 2014春夏, 我们通过服装传达<br />内心的宣言, 在宣言主题下, 是对原始自我<br />的重新认知和未来世界的无限畅想.</p>
            <p style=" text-align:center;font-family:Arial, Helvetica, sans-serif; font-size:12px; line-height:20px;padding:0px 25px 30px 25px;">Any clothing styles are able to be copied<br />and manufactured, only its soul and<br />spirit is eternal. Clothing is not only<br />products, which should be a kind of<br />attitude. Therefore, the spring 2014, we<br />adopted a declaration clothing to<br />convey inner, in the declaration under<br />the theme.
...
<div class="mainOriginal" style="height:800px; display:none;">
    <div class="kv" style="position:relative; width:960px; height:395px;">
        ...
        <img src="img/kv-original.jpg" width="960" height="395" style="position:absolute; top:0; left:0; z-index:-1;" /> <img src="img/playBtn.png" width="72" height="72" style="position:absolute; left:50px; bottom:40px;"  /> 
            ...
            <img src="img/original-videoword.png" height="17" style="position:absolute; left:149px; top:316px;"    /> 
        </div>
    <!--kv-->
    <div class="content clearfix" style="background:#fff;" >
