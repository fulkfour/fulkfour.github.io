...
(function($) {
    ...
    $.fn.supersized = function() {
        ...
        window.setTimeout("$('#supersize').resizenow()", 10);
    ...
    $.fn.resizenow = function() {
        ...
        return this.each(function() {
            $('#supersizeHolder').css('width', $('body').width());
            ...
            if ((browserheight < minheight) && (browserwidth < minwidth)) {
                ...
                var holderWidth = $('#supersizeHolder').width();
                var thisWidth = $(this).width();
                var widthDiff = (holderWidth - thisWidth) / 2;
                if (widthDiff < 0) {
                    $(this).css('left', widthDiff);
                }
